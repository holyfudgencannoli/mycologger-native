...
import TaskModal from "./detail-modal";
import * as Task from '@db/tasks'
import { useSQLiteContext } from "expo-sqlite";
import { TaskParamList } from "@navigation";
...
type NavigationProps = NativeStackNavigationProp<TaskParamList>
...
export default function TaskListScreen() {
    ...
    const getTaskData = async() => {
        const data: any = await Task.readAll(db)
        setTasks(data)
    }
                ...
                <Surface style={styles.surfaceMetaContainer}>
                  <Surface style={styles.surfaceContainer}>
                    {tasks && tasks.length > 0 ? (
                        ...
                        <>
                          <Text style={{ textAlign: 'center', color: '#fff', textShadowColor: 'black', textShadowRadius: 4 }}> 
                            No tasks yet!
                          </Text>
                        </>
                        )}
