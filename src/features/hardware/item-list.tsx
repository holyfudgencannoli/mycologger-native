...
import HardwareItemsPurchaseLogModal from "./detail-modal";
import * as ConItems from '@db/consumable-items'
...
export default function ItemList() {
    ...
    const getHardwareItemsData = async() => {
      const data = await ConItems.readAll(db)
            ...
            <ScreenPrimative>
                <Surface style={styles.surfaceMetaContainer}>                        
                    ...
                    {hardwareItems && hardwareItems.length > 0 ? (
                        <>
                        <ScrollableDataTable 
                            data={hardwareItems? hardwareItems : []}
                            columns={columns}
